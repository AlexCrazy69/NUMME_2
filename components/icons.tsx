...
// Using basic SVG paths to avoid full library dependency.
...
export const Book: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const Puzzle: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19.439 7.852c-2.102 0-3.807 1.705-3.807 3.808v.01c0 1.09.444 2.086 1.168 2.809 .723.723 1.718 1.168 2.808 1.168h.01c2.102 0 3.807-1.705 3.807-3.808s-1.705-3.808-3.808-3.808Z"/><path d="M10.213 9.812c0-2.102-1.705-3.807-3.808-3.807s-3.807 1.705-3.807 3.808v.009c0 1.09.444 2.086 1.168 2.809.723.723 1.718 1.168 2.808 1.168h.01c2.102 0 3.807-1.705 3.807-3.808Z"/><path d="M14.192 14.192c2.102 0 3.807 1.705 3.807 3.808s-1.705 3.807-3.807 3.807h-.01c-1.09 0-2.086-.444-2.809-1.168-.723-.723-1.168-1.718-1.168-2.808v-.01c0-2.102 1.705-3.807 3.808-3.807Z"/><path d="M4.561 14.192c2.102 0 3.808 1.705 3.808 3.808s-1.705 3.807-3.808 3.807c-1.09 0-2.086-.444-2.808-1.168-.723-.723-1.168-1.718-1.168-2.808v-.008c0-2.102 1.705-3.807 3.807-3.807Z"/></svg>
);
...
export const Flower: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 7.5a4.5 4.5 0 1 1 4.5 4.5M12 7.5A4.5 4.5 0 1 0 7.5 12M12 7.5V3m0 9h4.5m-4.5 0H7.5m4.5 0v4.5m0-4.5a4.5 4.5 0 1 1-4.5-4.5M12 16.5a4.5 4.5 0 1 0 4.5-4.5M12 16.5v4.5m0-4.5h4.5m-4.5 0H7.5m0 0A4.5 4.5 0 1 1 12 7.5M7.5 12a4.5 4.5 0 1 0-4.5 4.5"/></svg>
);
...
export const Certificate: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const Laptop: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55A1 1 0 0 1 20.28 20H3.72a1 1 0 0 1-.9-1.45L4 16"/></svg>
);
...
export const Twitter: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-6.1 1.2-10.1 5.2-10.1 5.2-2.1-1.4-4.2-1.7-4.2-1.7s-.5-1.4 1.4-2.8c-2.7-.5-5.2-2-5.2-2s-.8 4 2.1 6.3c-1.5 1.1-3.3 1.1-3.3 1.1s1.6 4.9 8.2 5.2c-2.7 3.3-8.2 4.9-8.2 4.9s3.3-1.2 6.1-3.2c4.9-1.8 11.2-7.5 11.2-7.5s-2.4 1.4-4.2 1.4c2.8-1.7 5.2-6 5.2-6z"/></svg>
);
...
export const BrainCircuit: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5a3 3 0 1 0-5.997.001A3 3 0 0 0 12 5zm0 0a3 3 0 1 0 5.997.001A3 3 0 0 0 12 5zm-5 4.1a2.2 2.2 0 0 1-1.8 1.1 2.5 2.5 0 0 0-2.2 2.3 2.5 2.5 0 0 0 2.2 2.3 2.2 2.2 0 0 1 1.8 1.1v0"/><path d="M17 9.1a2.2 2.2 0 0 0 1.8 1.1 2.5 2.5 0 0 1 2.2 2.3 2.5 2.5 0 0 1-2.2 2.3 2.2 2.2 0 0 0-1.8 1.1v0"/><path d="M12 9.5v-3"/><path d="M7 15.2v-2.3"/><path d="M17 15.2v-2.3"/><path d="M12 18.5v3"/><path d="m14.5 10.5 3-1"/><path d="m9.5 10.5-3-1"/></svg>
);

export const Trophy: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M8 12a4 4 0 0 1 8 0"/><path d="M12 2v6"/><path d="M6 12H2"/><path d="M18 12h4"/></svg>
);
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="3" y="3" rx="1"/></svg>
);
...
export const Sparkles: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 3L13.9 7.4L18.5 8.5L14.75 12.5L15.8 17.1L12 14.8L8.2 17.1L9.25 12.5L5.5 8.5L10.1 7.4L12 3Z"/><path d="M22 14L21.2 15.5L20 16L21.2 16.5L22 18L22.8 16.5L24 16L22.8 15.5L22 14Z"/><path d="M2 6L2.8 7.5L4 8L2.8 8.5L2 10L1.2 8.5L0 8L1.2 7.5L2 6Z"/></svg>
);
...
export const FlecheFaitiere: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M50 2L50 25" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
    <path d="M50 25L25 50" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
    <path d="M50 25L75 50" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
    <path d="M50 55L50 98" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
    <circle cx="25" cy="50" r="5" fill="currentColor"/>
    <circle cx="75" cy="50" r="5" fill="currentColor"/>
    <path d="M35 98L65 98" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
    <path d="M40 88L60 88" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
    <path d="M45 78L55 78" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
  </svg>
);

export const Nautile: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M50 50C50 38.9543 41.0457 30 30 30C18.9543 30 10 38.9543 10 50C10 61.0457 18.9543 70 30 70C41.0457 70 50 61.0457 50 50Z" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
      <path d="M30 70C30 81.0457 38.9543 90 50 90C61.0457 90 70 81.0457 70 70C70 58.9543 61.0457 50 50 50" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
      <path d="M70 70C81.0457 70 90 61.0457 90 50C90 38.9543 81.0457 30 70 30C58.9543 30 50 38.9543 50 50" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
  </svg>
);
